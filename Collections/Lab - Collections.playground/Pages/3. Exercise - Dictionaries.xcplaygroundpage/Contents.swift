...
var colorsArray = ["Yellow", "Red", "Black", "Blue"]
var NewshapesArray : [String: [String]] = ["Shapes":shapesArray, "Colors": colorsArray]
print(NewshapesArray)
...
//print(NewshapesArray[1][3])
if let colors = NewshapesArray["Colors"]
{   print(colors[2])
