 ...
 */
var walk : [String] = ["chal chala chal", "Walking Dead", "The Wrong walk"]
var run : [String] = ["Bhag", "Daud", "BHAG DK BOSE"]
...
if newarray.isEmpty
{   print("You're a Coward, do some challenges")
}
