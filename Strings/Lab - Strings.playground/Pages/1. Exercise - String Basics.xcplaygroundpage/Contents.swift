 ...
 */
let favoriteQuote = " \"Happiness is only real, when shared with others !\" "
...
emptyString.isEmpty ? print("There's nothing here") : print("It's not empty as I thought")
