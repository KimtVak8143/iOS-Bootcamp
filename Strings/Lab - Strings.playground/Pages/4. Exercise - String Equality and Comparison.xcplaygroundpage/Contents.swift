 ...
 */
let nameInCaps = "MOHIT"
let name = "mohit"
name == nameInCaps ? print("Two strings are equal") : print("The two strings are not equal.")
 ...
 */
name.lowercased() == nameInCaps.lowercased() ? print("\(name) and \(nameInCaps.lowercased()) are the same") : print("\(name) and \(nameInCaps.lowercased()) are not the same")
...
print("\(name) has \(name.count) letters ")
/*:
