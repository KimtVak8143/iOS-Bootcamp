...
var favoriteBook = Book(title: "It ends with us", author: "Colleen Hoover", pages: 360, price: 499)
/*:
...
var hp = Laptop(yearPurchased: 2020)
var lenovo = Laptop(screenSize: 14, repairCount: 20, yearPurchased: 2022)
...
struct Height
{
    ...
    {   self.heightInInches = heightInInches
        heightInCentimeteres = 2.54*heightInInches
