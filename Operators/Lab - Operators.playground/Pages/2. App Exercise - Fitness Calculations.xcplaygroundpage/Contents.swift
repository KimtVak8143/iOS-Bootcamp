 ...
 */
let heartRate1 : Int = 60, heartRate2 : Int = 75, heartRate3 : Int = 87
let addedHR = heartRate1+heartRate2+heartRate3
let averageHR = addedHR/3
print("Average Result = ", averageHR)
...
let heartRate1D : Double = 60, heartRate2D : Double = 75, heartRate3D : Double = 87
let addedHRD = heartRate1D+heartRate2D+heartRate3D
let averageHRD = addedHRD/3
print("Average Result Double = ", averageHRD)
...
print("Percent of Goal Completion = ", percentOfGoal)
/*:
