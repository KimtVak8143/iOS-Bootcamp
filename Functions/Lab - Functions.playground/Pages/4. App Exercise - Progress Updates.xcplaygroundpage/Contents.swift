...
progressUpdate(steps: 30, goal: 5000)
progressUpdate(steps: 19000, goal: 40000)
progressUpdate(steps: 20000, goal: 40000)
progressUpdate(steps: 6000, goal: 5000)
...
{   if currentTime < goaltime || currentDistance < totalDistance
    {   print("You've go to push it just a bit harder!")
    }
    else
    {   print("Keep it up!")
...
pacing(currentDistance: 30, totalDistance: 300, currentTime: 40, goaltime: 50)
